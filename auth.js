...
//  — Não é injetado no painel_de_escolhas_de_fichas.html
//    (aquela página usa a sidebar própria).
//  — Em todas as outras páginas (index, talentos, itens),
//    injeta um widget compacto no canto superior direito.
// ════════════════════════════════════════════════════════════
function injetarUsuarioNav() {
    ...
    widget.innerHTML = `
        <style>
            ...
            #_widget-usuario .wu-btn-logout svg {
                flex-shrink: 0;
            }

            /* Em mobile, esconde o texto "Sair" para economizar espaço */
